...
export const portfolioItems: PortfolioItem[] = [
  ...
  },
  {
    ...
    galleryMedia: [
      { id: 'gallery-9-1', type: 'image', url: ilFuocoChef, alt: 'IL FUOCO PIZZA - Chef bereidt pizza' },
      { id: 'gallery-9-2', type: 'video', url: '/videos/portfolio/il-fuoco-promo.mp4', posterUrl: ilFuocoChef, alt: 'IL FUOCO PIZZA - Promo video' },
      { id: 'gallery-9-3', type: 'image', url: ilFuocoMenu, alt: 'IL FUOCO PIZZA - Menu design' },
      { id: 'gallery-9-4', type: 'image', url: ilFuocoReviews, alt: 'IL FUOCO PIZZA - Reviews sectie' },
      { id: 'gallery-9-5', type: 'image', url: ilFuocoEvents, alt: 'IL FUOCO PIZZA - Events pagina' },
      { id: 'gallery-9-6', type: 'image', url: ilFuocoDeals, alt: 'IL FUOCO PIZZA - Deals en acties' },
      { id: 'gallery-9-7', type: 'image', url: ilFuocoInstagram, alt: 'IL FUOCO PIZZA - Instagram post' },
    ],
