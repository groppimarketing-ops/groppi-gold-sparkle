          ...
          <GlassCard className="max-w-4xl mx-auto text-center p-8 md:p-12 relative overflow-hidden border-primary/30">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
              <Button 
                asChild 
                size="lg" 
                className="luxury-button hover:shadow-[0_0_30px_hsl(43_100%_50%/0.4)]"
              >
                <Link to="/contact">
              ...
              <Button 
                size="lg" 
                variant="outline"
                className="glass-button hover:border-primary/50 hover:shadow-[0_0_20px_hsl(43_100%_50%/0.2)]"
