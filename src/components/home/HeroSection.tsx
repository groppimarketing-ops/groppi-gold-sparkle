      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        >
          <motion.h1
            ...
            className="text-5xl md:text-7xl lg:text-8xl font-display font-bold mb-6 gold-gradient-text gold-text-glow"
          >
            {t('hero.title')}
          </motion.h1>
          ...
          >
            <Button
              asChild
              size="lg"
              className="luxury-button text-primary-foreground font-semibold px-8 py-6 text-lg"
            >
              <Link to="/services">
                {t('hero.cta')}
