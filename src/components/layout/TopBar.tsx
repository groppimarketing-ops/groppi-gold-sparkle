...
const socialIconsData = [
  ...
  { 
    ...
    color: '#1877F2',
    hoverGlow: 'hover:drop-shadow-[0_0_8px_rgba(24,119,242,0.6)]'
  },
  { 
    icon: InstagramIcon, 
    ...
    color: '#E4405F',
    hoverGlow: 'hover:drop-shadow-[0_0_8px_rgba(228,64,95,0.6)]'
  },
  { 
    icon: LinkedInIcon, 
  ...
  { 
    ...
    color: '#FF0000',
    hoverGlow: 'hover:drop-shadow-[0_0_8px_rgba(255,0,0,0.6)]'
  },
  { 
    icon: TikTokIcon, 
    ...
    color: '#69C9D0',
    hoverGlow: 'hover:drop-shadow-[0_0_8px_rgba(105,201,208,0.6)]'
  },
  { 
    icon: PinterestIcon, 
    ...
    color: '#E60023',
    hoverGlow: 'hover:drop-shadow-[0_0_8px_rgba(230,0,35,0.6)]'
  },
];
...
const TopBar = () => {
  ...
  return (
    <TooltipProvider delayDuration={300}>
      <div className="fixed top-0 left-0 right-0 z-[60] bg-background/95 backdrop-blur-md border-b border-white/[0.06]">
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <a
                    ...
                    onClick={() => trackEvent({ event: 'email_click', location: 'topbar' })}
              ...
              <Tooltip>
                <TooltipTrigger asChild>
                  <a
                    ...
                    onClick={() => trackEvent({ event: 'phone_click', location: 'topbar' })}
                    className="flex items-center gap-1.5 text-xs text-muted-foreground hover:text-primary transition-colors duration-200"
                  >
              ...
              {socialIconsData.map((social) => (
                <Tooltip key={social.label}>
                  <TooltipTrigger asChild>
                    ...
                    >
                      <social.icon className="h-[18px] w-[18px] md:h-5 md:w-5" />
                    </motion.a>
                  </TooltipTrigger>
